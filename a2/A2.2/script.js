...
function setup() {
  ...
  sel.option('Frog', '/images/img1.png');
  sel.option('Uncle', 'C:/Users/Admin/Desktop/Srishti/Programming and prototyping/SITE/img2.jpg');
  sel.option('Kanye', "C:/Users/Admin/Desktop/Srishti/Programming and prototyping/SITE/img3.jpg");
  sel.changed(imageUpdate);
  let m1 = sel.value();
  im1 = loadImage(m1);
  let p9 = createP('Save Your Meme');
